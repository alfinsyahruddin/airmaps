...
object EditLocationDestination : NavigationDestination {
    override val route = "edit_location"
    override val titleRes = R.string.edit_location
...
fun EditLocationPage(
    ...
    Scaffold(
        ...
        topBar = {
            AppBar(
                title = stringResource(EditLocationDestination.titleRes),
                    ...
                    onClick = {
                        coroutineScope.launch {
                            ...
                            mainThread {
                                Toast.makeText(
                                    context,
                                    R.string.edit_location_success,
                                    Toast.LENGTH_SHORT
                                ).show()
                                navigateBack()
                            }
